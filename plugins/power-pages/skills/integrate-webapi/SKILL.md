...
**When the sentinel is absent**: proceed exactly as today (full CRUD, full interactive flow). This is the regression guard — no human invocation changes behavior.
